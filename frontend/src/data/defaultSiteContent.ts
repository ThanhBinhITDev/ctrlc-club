...
export const defaultSiteContent: SiteContent = {
  ...
  hero: {
    ...
    description:
      "Chung toi xay dung mot moi truong de sinh vien luyen ky nang ky thuat, van hanh nhom, va tu duy trach nhiem thong qua workshop, du an noi bo va cac hoat dong cong dong.",
  ...
  activities: {
    ...
    description:
      "Moi giai doan deu huong thanh vien vao mot ket qua ro rang: hieu he thong, lam viec co quy trinh, va co kha nang ban giao san pham trong nhom.",
    items: [
      {
        index: "01",
  ...
  contact: {
    ...
    description:
      "Phan public da co huong noi dung ro, con khu admin da san cho viec tiep tuc them module quan ly va du lieu that.",
  ...
  footer: {
    title: "CTRL/C CLUB",
    description:
      "Noi ket noi sinh vien yeu cong nghe thong qua du an, workshop va van hoa lam viec tu te.",
